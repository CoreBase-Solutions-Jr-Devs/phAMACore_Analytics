...
const UiSwiperSlider = () => {
    ...
    // Helper function to compute safe loop and slidesPerView settings
    const getSwiperConfig = (slideCount, requestedSlidesPerView = 1, requestedLoop = true) => {
        if (!requestedLoop) {
            return {
                loop: false,
                slidesPerView: Math.min(requestedSlidesPerView, slideCount),
                slidesPerGroup: 1
            };
        }
        
        // Swiper requires strictly more than slidesPerView + 2 for reliable loop
        const minSlidesForLoop = requestedSlidesPerView + 2;
        if (slideCount > minSlidesForLoop) {
            return {
                loop: true,
                slidesPerView: requestedSlidesPerView,
                slidesPerGroup: 1
            };
        }
        
        // If not enough slides for loop with requested slidesPerView, reduce slidesPerView to allow loop
        const maxSlidesPerViewForLoop = Math.max(1, slideCount - 2);
        if (maxSlidesPerViewForLoop >= 1 && slideCount > 3) {
            return {
                loop: true,
                slidesPerView: maxSlidesPerViewForLoop,
                slidesPerGroup: 1
            };
        }
        
        // Not enough slides for loop at all
        return {
            loop: false,
            slidesPerView: Math.min(requestedSlidesPerView, slideCount),
            slidesPerGroup: 1
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper className="mySwiper swiper default-swiper rounded" modules={[Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }}>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper modules={[Navigation, Pagination, Autoplay]} pagination={{ clickable: true }} navigation={true} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper navigation-swiper rounded">
                                        <div className="swiper-wrapper">
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper pagination={{ clickable: true, dynamicBullets: true, }} modules={[Pagination, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper pagination-dynamic-swiper rounded" >
                                        <div className="swiper-wrapper">
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper pagination={{ type: "fraction", clickable: true }} navigation={true} modules={[Pagination, Navigation, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper pagination-fraction-swiper rounded" >
                                        <div className="swiper-wrapper">
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper pagination={{ el: '.swiper-pagination', pagination }} modules={[Pagination, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper pagination-custom-swiper rounded" >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide><img src={img2} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img3} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img4} alt="" className="img-fluid" /></SwiperSlide>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper pagination={{ type: "progressbar" }} navigation={true} modules={[Pagination, Navigation, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper pagination-progress-swiper rounded" >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide><img src={img5} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img6} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img7} alt="" className="img-fluid" /></SwiperSlide>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper scrollbar={{ hide: true, }} modules={[Scrollbar, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper pagination-scrollbar-swiper rounded">
                                        <div className="swiper-wrapper">
                                            <SwiperSlide><img src={img8} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img9} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img10} alt="" className="img-fluid" /></SwiperSlide>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper direction={"vertical"} pagination={{ clickable: true }} modules={[Pagination, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper vertical-swiper rounded" style={{ height: "324px" }}>
                                        <div className="swiper-wrapper">
                                            <SwiperSlide><img src={img11} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img12} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img1} alt="" className="img-fluid" /></SwiperSlide>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper direction={"vertical"} spaceBetween={30} mousewheel={true}
                                        pagination={{
                                            clickable: true,
                                        }} modules={[Mousewheel, Pagination, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper mousewheel-control-swiper rounded" style={{ height: "324px" }} >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide><img src={img3} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img4} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img5} alt="" className="img-fluid" /></SwiperSlide>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper spaceBetween={30} effect={"fade"} pagination={{ clickable: true, }} modules={[EffectFade, Pagination, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper effect-fade-swiper rounded" >
                                        <SwiperSlide> <img src={img6} alt="" className="img-fluid" /> </SwiperSlide>
                                        <SwiperSlide> <img src={img7} alt="" className="img-fluid" /> </SwiperSlide>
                                        <SwiperSlide> <img src={img8} alt="" className="img-fluid" /> </SwiperSlide>
                                    </Swiper>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper grabCursor={true} effect={"creative"} pagination={{ clickable: true }}
                                        ...
                                        }} modules={[EffectCreative, Pagination, Autoplay]} {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }} className="mySwiper swiper effect-creative-swiper rounded">
                                        <div className="swiper-wrapper">
                                            <SwiperSlide><img src={img9} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img10} alt="" className="img-fluid" /></SwiperSlide>
                                            <SwiperSlide><img src={img11} alt="" className="img-fluid" /></SwiperSlide>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper
                                        ...
                                        {...getSwiperConfig(3, 1, true)} autoplay={{ delay: 2500, disableOnInteraction: false }}
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Swiper effect={"coverflow"} grabCursor={true} centeredSlides={true} autoplay={{
                                        ...
                                        modules={[EffectCoverflow, Pagination, Autoplay]} {...getSwiperConfig(6, 3, true)} className="mySwiper swiper effect-coverflow-swiper rounded pb-5"
                                    >
                                        <div className="swiper-wrapper">
                                            <SwiperSlide> <img src={img4} alt="" className="img-fluid" /> </SwiperSlide>
                                            <SwiperSlide> <img src={img5} alt="" className="img-fluid" /> </SwiperSlide>
